	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!nome1.equals("") && !nome2.equals("") && !nome3.equals("") && !nome4.equals("") && !nome5.equals("")) {
			...
			if(ruoli.contains("Pivot") && ruoli.contains("Portiere") && ruoli.contains("Laterale 1") 
				...
				Giocatore giocatore1 = new Giocatore(nome1, cognome1, nmaglia1, ruolo1, squadra);
				aggiungiGiocatore(giocatore1);
				Giocatore giocatore2 = new Giocatore(nome2, cognome2, nmaglia2, ruolo2, squadra);
				aggiungiGiocatore(giocatore2);
				Giocatore giocatore3 = new Giocatore(nome3, cognome3, nmaglia3, ruolo3, squadra);
				aggiungiGiocatore(giocatore3);
				Giocatore giocatore4 = new Giocatore(nome4, cognome4, nmaglia4, ruolo4, squadra);
				aggiungiGiocatore(giocatore4);
				Giocatore giocatore5 = new Giocatore(nome5, cognome5, nmaglia5, ruolo5, squadra);
