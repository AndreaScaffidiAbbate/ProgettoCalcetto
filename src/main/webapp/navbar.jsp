    ...
    <button class="navbar-toggler" type="button" data-mdb-toggle="collapse" data-mdb-target="#navbarSupportedContent"
     ...
     <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link imglogo" aria-current="page" href="home_user.jsp">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link imglogo" aria-current="page" href="calendar_home.jsp">Calendario</a>
        </li>
      </ul>
    </div>
    ...
    <ul class="navbar-nav">
       <li class="nav-item dropdown dropdown-menu-right">
	        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
	          <img src="https://freesvg.org/img/abstract-user-flat-3.png" width="40" height="40" class="rounded-circle">
	        </a>
